 ...
 * @GST_VIDEO_FORMAT_NV12_128C8: NV12 split as 128pixel wide columns (Since: 1.28)
 * @GST_VIDEO_FORMAT_NV12_10LE32_128C8: 10-bit NV12 split as 96pixel/128byte wide columns (Since: 1.28)
 *
...
typedef enum {
   ...
   *
   * NV12 tiled as 128 pixel wide columns
   *
   * Since: 1.28
   */
  GST_VIDEO_FORMAT_NV12_128C8,
  ...
  /**
   * GST_VIDEO_FORMAT_NV12LE32_10COL128:
   *
