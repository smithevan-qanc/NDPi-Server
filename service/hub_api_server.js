...
class NDPiCommandServer_Client extends EventEmitter {
    ...
    __Routers() {
        ...
        .route('/api/v1/rpc')
        .get(async (req, res) => {
            // to use: http://<hostname>:<port>/api/v1/rpc?type=set-source&data=EVAN-MSI (OBS PGM)
    ...
    __RoutesDevices() {
        ...
        deviceCommandRoute('overlay', () => ({ type: 'show-overlay' }));
    ...
    __RoutesGroups() {
        ...
        groupCommandRoute('overlay', () => ({ type: 'show-overlay' }));
        groupCommandRoute('blank', () => ({ type: 'show-blank' }));
